...
JP to provide MD application descriptions and configurations
 
\section{Results}

In this section, we discuss the performance of both the LAMMPS and HOOMD molecular dynamics simulation tools when running within a virtualized environment. Specifically, we scale each application to 32 cores, both in native and virtualized environments. 
