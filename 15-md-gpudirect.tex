...
\conferenceinfo{CONF '15}{Month d--d, 20yy, City, ST, Country} 
\copyrightyear{2015} 
...
List \cite{www-top500} and represent an increasing shift towards accelerators for
HPC applications. Recently efforts have been seen to support such GPU
accelerators within VMs using IOMMU technologies, with implementations
